...
for i in range(len(dirListing)):
    ...
    if Songwriter=="Ceza" or Songwriter=="Sagopa Kajmer" or Songwriter=="Allame" or Songwriter=="Gazapizm" or Songwriter=="Gazapizm":
        df_Actual['Genre'] = "Rap"
    elif Songwriter=="Sezen Aksu":
        df_Actual['Genre'] = "Pop"
    elif Songwriter=="Duman" or Songwriter=="Ogun Sanlisoy" or Songwriter=="Teoman" or Songwriter=="Sebnem Ferah":
...
elif FeatureSelection=='Kbest':##decrease k
